...
plot [][]  \
  '../runsQ/MIx32x1/mi_S_Q8.txt' i 1    u ($1-ip1):($8-$19) w l ls 555 t '100 M, bin =  1  ', \
  '../runsQ/MIx32x4/mi_S_Q8.txt' i 1    u ($1-ip1):($8-$19) w l ls 55  t '100 M, bin = 1/4', \
  '../runsQ/MIx32x8/mi_S_Q8.txt' i 1    u ($1-ip1):($8-$19) w l ls 5   t '100 M, bin = 1/8', \
  '../runsQ/MIx32x1a/mi_S_Q8.txt' i 1    u ($1-ip1):($8-$19) w p ls 333 t '30 M, bin =  1 ', \
  '../runsQ/MIx32x4a/mi_S_Q8.txt' i 1    u ($1-ip1):($8-$19) w p ls 33  t '30 M, bin = 1/4', \
  '../runsQ/MIx32x8a/mi_S_Q8.txt' i 1    u ($1-ip1):($8-$19) w p ls 3   t '30 M, bin = 1/8'
...
plot [][]  \
  '../runsQ/MIx32x1/mi_mi_Q8.txt' i 1    u ($1-ip1):($4) w l ls 555 t '100 M, bin =  1  ', \
  '../runsQ/MIx32x4/mi_mi_Q8.txt' i 1    u ($1-ip1):($4) w lp ls 55  t '100 M, bin = 1/4', \
  '../runsQ/MIx32x8/mi_mi_Q8.txt' i 1    u ($1-ip1):($4) w lp ls 5   t '100 M, bin = 1/8', \
  '../runsQ/MIx32x1a/mi_mi_Q8.txt' i 1    u ($1-ip1):($4) w p ls 333 t '30 M, bin =  1 ', \
  '../runsQ/MIx32x4a/mi_mi_Q8.txt' i 1    u ($1-ip1):($4) w lp ls 33  t '30 M, bin = 1/4', \
  '../runsQ/MIx32x8a/mi_mi_Q8.txt' i 1    u ($1-ip1):($4) w lp ls 3   t '30 M, bin = 1/8'
...
plot [][]  \
  '../runsQ/MIx32x1/mi_mi_Q8.txt' i 1    u ($1-ip1):($2) w l ls 555 t '100 M, bin =  1  ', \
  '../runsQ/MIx32x4/mi_mi_Q8.txt' i 1    u ($1-ip1):($2) w lp ls 55  t '100 M, bin = 1/4', \
  '../runsQ/MIx32x8/mi_mi_Q8.txt' i 1    u ($1-ip1):($2) w lp ls 5   t '100 M, bin = 1/8', \
  '../runsQ/MIx32x1a/mi_mi_Q8.txt' i 1    u ($1-ip1):($2) w p ls 333 t '30 M, bin =  1 ', \
  '../runsQ/MIx32x4a/mi_mi_Q8.txt' i 1    u ($1-ip1):($2) w lp ls 33  t '30 M, bin = 1/4', \
  '../runsQ/MIx32x8a/mi_mi_Q8.txt' i 1    u ($1-ip1):($2) w lp ls 3   t '30 M, bin = 1/8'
...
plot [][]  \
  '../runsQ/MIx32x1/mi_mi_Q8.txt' i 1    u ($1-ip1):($6) w l ls 555 t '100 M, bin =  1  ', \
  '../runsQ/MIx32x4/mi_mi_Q8.txt' i 1    u ($1-ip1):($6) w lp ls 55  t '100 M, bin = 1/4', \
  '../runsQ/MIx32x8/mi_mi_Q8.txt' i 1    u ($1-ip1):($6) w lp ls 5   t '100 M, bin = 1/8', \
  '../runsQ/MIx32x1a/mi_mi_Q8.txt' i 1    u ($1-ip1):($6) w p ls 333 t '30 M, bin =  1 ', \
  '../runsQ/MIx32x4a/mi_mi_Q8.txt' i 1    u ($1-ip1):($6) w lp ls 33  t '30 M, bin = 1/4', \
  '../runsQ/MIx32x8a/mi_mi_Q8.txt' i 1    u ($1-ip1):($6) w lp ls 3   t '30 M, bin = 1/8'
