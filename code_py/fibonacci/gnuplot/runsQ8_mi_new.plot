...
# index 2: q8_v0dt1
  ...
  plot[0:64][0:0.355] 'mi_data.txt'  \
   ...
   '' u (ip2-$1):($2) i 3  w lp ls 3  t '3-mode MI',\
   '' u (ip2-$1):($2) i 4  w lp ls 3  t '2-mode MI', \
   '' u (ip3-$1):($2) i 7  w lp ls 4  t '3-mode MI',\
   '' u (ip3-$1):($2) i 8  w lp ls 4  t '2-mode MI'
...
# index 2: q8_v0dt1
  ...
  plot[4:48][0.0:0.35] 'mi_data.txt'  \
   ...
   '../runsQ/MI/mi_mi_Q8.txt' \
    ...
    '' u ($1-ip2):($2) i 5  w lp ls 3 notitle,\
    '' u ($1-ip2):($2) i 6  w lp ls 4 notitle
