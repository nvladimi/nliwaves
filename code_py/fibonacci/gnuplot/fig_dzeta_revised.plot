...
set output 'fig_dzeta_revised.pdf'
...
plot [0:60][-0.25:0]   '../runsQ/MIx32x1/mi_S_Q8.txt' \
  ...
  '' i 1  u ($1):($8-$19) w lp ls 200 t '{/Symbol a} = 1', \
    0.005*(x-55) w l ls 101 t '\~ 0.005 i', \
   -0.005*(x-10) w l ls 202 t '\~ (-0.005) i'
...
set ytics 0.01 font "Helvetica, 6" center offset -1, 0 
...
plot [0:4][-0.03:0.03] \
   'dzeta_data.txt' u ($1):($1*d3a/3. - $3)  i 2 w lp ls 100 t '{/Symbol a} = 0', \
   'dzeta_data.txt' u ($1):($1*d3b/3. - $3)  i 3 w lp ls 200 t '{/Symbol a} = 1' #, \
  -0.005*x w l ls 202 t '- 0.005 p', \
   0.005*x w l ls 101 t '  0.005 p'
