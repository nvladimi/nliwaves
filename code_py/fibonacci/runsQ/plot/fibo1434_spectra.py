...
#import importlib ; import fibo1434_spectra
#importlib.reload(fibo1434_spectra) ; fibo1434_spectra.all()
...
def all(): 
    ...
    #datv34 = np.loadtxt("../POSTFrisch/q7_v34R27_flx.txt")
    #datv34 = np.loadtxt("../POSTFrisch/q7_v34R29_flx.txt")
