...
datP1dt1  = np.loadtxt("Post/s1_v14_P1_dt1_mcr.txt")
datP1dt2  = np.loadtxt("Post/s1_v14_P1_dt2_mcr.txt")
datP1dt3  = np.loadtxt("Post/s1_v14_P1_dt3_mcr.txt")
...
iax.text(5, 5.5, "$\\alpha = 1/4$")
iax.axhline(y=4, color='gray', lw = 0.5)
