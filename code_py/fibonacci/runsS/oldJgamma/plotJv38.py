...
datP1dt1  = np.loadtxt("Post/s1_v38_P1_dt1_mcr.txt")
datP1dt2  = np.loadtxt("Post/s1_v38_P1_dt2_mcr.txt")
datP1dt3  = np.loadtxt("Post/s1_v38_P1_dt3_mcr.txt")
datPtdt2  = np.loadtxt("Post/s1_v38_Pt_dt2_mcr.txt")
...
y = datPtdt2[:,1]
iax.plot(x,y, 'g-',  mfc='none', ms=MS,  lw=LW,  label="$c_P = 0.3420$");
...
iax.axhline(y=-0.3420, color='gray', lw = 0.5)
