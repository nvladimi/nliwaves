...
datP1dt1  = np.loadtxt("Post/s1_m50_P1_dt1_mcr.txt")
datP1dt2  = np.loadtxt("Post/s1_m50_P1_dt2_mcr.txt")
datP1dt3  = np.loadtxt("Post/s1_m50_P1_dt3_mcr.txt")
datPtdt2  = np.loadtxt("Post/s1_m50_Pt_dt2_mcr.txt")
