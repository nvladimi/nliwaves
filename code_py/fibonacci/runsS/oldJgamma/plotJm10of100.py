...
g050  = np.loadtxt("Post/s2_m10_G050_dt2_mcr.txt")
g060  = np.loadtxt("Post/s2_m10_G060_dt2_mcr.txt")
g067  = np.loadtxt("Post/s2_m10_G067_dt2_mcr.txt")
g075  = np.loadtxt("Post/s2_m10_G075_dt2_mcr.txt")
g100  = np.loadtxt("Post/s2_m10_G100_dt2_mcr.txt")
