...
ishift1 = int(sys.argv[2])  #shift for m3
ishift2 = int(sys.argv[3])  #shift for m2
ishift3 = int(sys.argv[4])  #shift for m2
...
for run in runs:
    ...
    y2 = dat2[i1-ishift1:i2-ishift1,3] * dat1[i1-ishift2:i2-ishift2,1] * dat1[i1-ishift3:i2-ishift3,1] * sc
    y = y1-y2
