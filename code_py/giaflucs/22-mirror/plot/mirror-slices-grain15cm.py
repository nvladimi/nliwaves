...
outfile = "mirror-slices-grain15cm.pdf"
...
for rset in runs:
    ...
    fname = "../2022-05-05_grain15cm/data/lega" + run + "_last.txt" 
    print(fname)
    ...
    fname = "../2022-05-05_grain15cm/data/zero" + run + "_last.txt" 
    print(fname)
...
for i in (0,1,2,3):
    ...
    ax[i][0].set_xlim(-40,40)
    ax[i][2].set_xlim(-40,40)
