...
outfile = "mirror-forth-n-back-graining.pdf"
...
for rset in runs:
    run = rset[0]
    fname = "../2022-05-04_graining/data/lega" + run + "/lega" + run + ".000000" 
    print(fname)
...
for rset in runs:
    run = rset[0]
    fname = "../2022-05-04_graining/data/zero" + run + "/zero" + run + ".000000" 
    print(fname)
    label = rset[2]
