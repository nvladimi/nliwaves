...
outfile = "mirror-forth-n-back-blurr15cm.pdf"
...
for rset in runs:
    run = rset[0]
    fname = "../2022-05-05_blurr15cm/data/lega" + run + "/lega" + run + ".000000" 
    print(fname)
...
for rset in runs:
    run = rset[0]
    fname = "../2022-05-05_blurr15cm/data/zero" + run + "/zero" + run + ".000000" 
    print(fname)
    label = rset[2]
