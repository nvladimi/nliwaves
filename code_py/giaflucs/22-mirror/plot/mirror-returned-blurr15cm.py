...
outfile = "mirror-returned-blurr15cm.pdf"
...
fig, ax = plt.subplots(ncols=4, nrows=1, figsize=(12,2.8))


fname = "../2022-05-05_blurr15cm/data/lega.txt"
...
fname = "../2022-05-05_blurr15cm/data/zero.txt"
dat = np.loadtxt(fname,  comments='%')
...
for iax in (ax[0], ax[1], ax[2], ax[3]):
    iax.set_xlim(0,10)
    iax.set_ylim(0,1.0)
...
ax[3].set_ylim(0,70)
ax[2].legend(frameon=False, labelspacing = 0.3, loc="lower right")
...
plt.subplots_adjust(left=0.10, right=0.98, top=0.98, bottom=0.14, wspace=0.25, hspace=0.25)
