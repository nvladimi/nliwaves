...
outfile = "mirror-returned-blurramp15.pdf"
...
fname = "../2022-06-19_blurramp15/data/lega.txt"
...
fname = "../2022-06-19_blurramp15/data/zero.txt"
dat = np.loadtxt(fname,  comments='%')
...
for iax in (ax[0], ax[1], ax[2], ax[3], ax[4]):
    ...
    iax.legend(frameon=False, labelspacing = 0.3, loc="upper left")
...
ax[3].set_ylim(0,12)
ax[4].set_ylim(0,50)
ax[2].legend(frameon=False, labelspacing = 0.3, loc="lower left")
