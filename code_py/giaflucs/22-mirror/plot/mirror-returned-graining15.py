...
outfile = "mirror-returned-graining15.pdf"
...
fname = "../2022-06-19_graining15/data/lega.txt"
...
fname = "../2022-06-19_graining15/data/zero.txt"
dat = np.loadtxt(fname,  comments='%')
...
ax[3].set_ylim(0,70)
ax[4].set_ylim(0,100)
ax[1].legend(frameon=False, labelspacing = 0.3, loc="upper right")
