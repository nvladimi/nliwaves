#import importlib ; import plotFlat_Ismall
#importlib.reload(plotFlat_Ismall) ; plotFlat_Ismall.Plot()
        ...
        for i in (0, 1, 2, 3):
            for j in range (0,3):
                ...
                ax[j,i].plot(dat[:,0], dat[:,1], MT[f], label=ML[f],
                             markersize=MS,  mfc=MFC, linewidth=0.25)
